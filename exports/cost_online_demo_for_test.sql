...
ALTER TABLE IF EXISTS ONLY public.work_logs DROP CONSTRAINT IF EXISTS work_logs_work_type_id_fkey;
ALTER TABLE IF EXISTS ONLY public.work_logs DROP CONSTRAINT IF EXISTS work_logs_machine_id_fkey;
ALTER TABLE IF EXISTS ONLY public.work_logs DROP CONSTRAINT IF EXISTS work_logs_employee_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tool_depreciation DROP CONSTRAINT IF EXISTS tool_depreciation_tool_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tool_depreciation DROP CONSTRAINT IF EXISTS tool_depreciation_finished_good_id_fkey;
ALTER TABLE IF EXISTS ONLY public.sales DROP CONSTRAINT IF EXISTS sales_finished_good_id_fkey;
ALTER TABLE IF EXISTS ONLY public.purchases DROP CONSTRAINT IF EXISTS purchases_supplier_id_fkey;
ALTER TABLE IF EXISTS ONLY public.purchases DROP CONSTRAINT IF EXISTS purchases_material_id_fkey;
ALTER TABLE IF EXISTS ONLY public.plate_part_templates DROP CONSTRAINT IF EXISTS plate_part_templates_plate_material_type_id_fkey;
ALTER TABLE IF EXISTS ONLY public.misc_expenses DROP CONSTRAINT IF EXISTS misc_expenses_balance_entry_id_fkey;
ALTER TABLE IF EXISTS ONLY public.misc_expense_machine_links DROP CONSTRAINT IF EXISTS misc_expense_machine_links_finished_good_id_fkey;
ALTER TABLE IF EXISTS ONLY public.misc_expense_machine_links DROP CONSTRAINT IF EXISTS misc_expense_machine_links_expense_id_fkey;
ALTER TABLE IF EXISTS ONLY public.materials DROP CONSTRAINT IF EXISTS materials_type_id_fkey;
ALTER TABLE IF EXISTS ONLY public.materials DROP CONSTRAINT IF EXISTS materials_plate_material_type_id_fkey;
ALTER TABLE IF EXISTS ONLY public.material_transactions DROP CONSTRAINT IF EXISTS material_transactions_material_id_fkey;
ALTER TABLE IF EXISTS ONLY public.material_inventory DROP CONSTRAINT IF EXISTS material_inventory_material_id_fkey;
ALTER TABLE IF EXISTS ONLY public.material_conversions DROP CONSTRAINT IF EXISTS material_conversions_template_id_fkey;
ALTER TABLE IF EXISTS ONLY public.material_conversions DROP CONSTRAINT IF EXISTS material_conversions_target_material_id_fkey;
ALTER TABLE IF EXISTS ONLY public.material_conversions DROP CONSTRAINT IF EXISTS material_conversions_source_purchase_id_fkey;
ALTER TABLE IF EXISTS ONLY public.material_conversions DROP CONSTRAINT IF EXISTS material_conversions_source_material_id_fkey;
ALTER TABLE IF EXISTS ONLY public.machine_tools DROP CONSTRAINT IF EXISTS machine_tools_tool_id_fkey;
ALTER TABLE IF EXISTS ONLY public.machine_tools DROP CONSTRAINT IF EXISTS machine_tools_machine_id_fkey;
ALTER TABLE IF EXISTS ONLY public.machine_materials DROP CONSTRAINT IF EXISTS machine_materials_material_id_fkey;
ALTER TABLE IF EXISTS ONLY public.machine_materials DROP CONSTRAINT IF EXISTS machine_materials_machine_id_fkey;
ALTER TABLE IF EXISTS ONLY public.machine_labor_costs DROP CONSTRAINT IF EXISTS machine_labor_costs_work_type_id_fkey;
ALTER TABLE IF EXISTS ONLY public.machine_labor_costs DROP CONSTRAINT IF EXISTS machine_labor_costs_machine_id_fkey;
ALTER TABLE IF EXISTS ONLY public.inventory_adjustments DROP CONSTRAINT IF EXISTS inventory_adjustments_material_id_fkey;
ALTER TABLE IF EXISTS ONLY public.indirect_cost_allocations DROP CONSTRAINT IF EXISTS indirect_cost_allocations_finished_good_id_fkey;
ALTER TABLE IF EXISTS ONLY public.indirect_cost_allocations DROP CONSTRAINT IF EXISTS indirect_cost_allocations_category_id_fkey;
ALTER TABLE IF EXISTS ONLY public.finished_goods DROP CONSTRAINT IF EXISTS finished_goods_machine_id_fkey;
ALTER TABLE IF EXISTS ONLY public.finished_good_material_reservations DROP CONSTRAINT IF EXISTS finished_good_material_reservations_purchase_id_fkey;
ALTER TABLE IF EXISTS ONLY public.finished_good_material_reservations DROP CONSTRAINT IF EXISTS finished_good_material_reservations_material_id_fkey;
ALTER TABLE IF EXISTS ONLY public.finished_good_material_reservations DROP CONSTRAINT IF EXISTS finished_good_material_reservations_finished_good_id_fkey;
ALTER TABLE IF EXISTS ONLY public.finished_good_material_consumptions DROP CONSTRAINT IF EXISTS finished_good_material_consumptions_purchase_id_fkey;
ALTER TABLE IF EXISTS ONLY public.finished_good_material_consumptions DROP CONSTRAINT IF EXISTS finished_good_material_consumptions_material_id_fkey;
ALTER TABLE IF EXISTS ONLY public.finished_good_material_consumptions DROP CONSTRAINT IF EXISTS finished_good_material_consumptions_finished_good_id_fkey;
ALTER TABLE IF EXISTS ONLY public.finished_good_labor DROP CONSTRAINT IF EXISTS finished_good_labor_work_log_id_fkey;
ALTER TABLE IF EXISTS ONLY public.finished_good_labor DROP CONSTRAINT IF EXISTS finished_good_labor_finished_good_id_fkey;
ALTER TABLE IF EXISTS ONLY public.employee_settlements DROP CONSTRAINT IF EXISTS employee_settlements_employee_id_fkey;
ALTER TABLE IF EXISTS ONLY public.composite_material_recipes DROP CONSTRAINT IF EXISTS composite_material_recipes_output_material_id_fkey;
ALTER TABLE IF EXISTS ONLY public.composite_material_recipe_items DROP CONSTRAINT IF EXISTS composite_material_recipe_items_recipe_id_fkey;
ALTER TABLE IF EXISTS ONLY public.composite_material_recipe_items DROP CONSTRAINT IF EXISTS composite_material_recipe_items_material_id_fkey;
DROP INDEX IF EXISTS public.idx_misc_expenses_date;
DROP INDEX IF EXISTS public.idx_misc_expense_machine_links_fg;
DROP INDEX IF EXISTS public.idx_app_operations_log_created_at;
ALTER TABLE IF EXISTS ONLY public.work_types DROP CONSTRAINT IF EXISTS work_types_pkey;
ALTER TABLE IF EXISTS ONLY public.work_types DROP CONSTRAINT IF EXISTS work_types_name_key;
ALTER TABLE IF EXISTS ONLY public.work_logs DROP CONSTRAINT IF EXISTS work_logs_pkey;
ALTER TABLE IF EXISTS ONLY public.tools DROP CONSTRAINT IF EXISTS tools_pkey;
ALTER TABLE IF EXISTS ONLY public.tool_depreciation DROP CONSTRAINT IF EXISTS tool_depreciation_pkey;
ALTER TABLE IF EXISTS ONLY public.tax_payments DROP CONSTRAINT IF EXISTS tax_payments_pkey;
...
ALTER TABLE IF EXISTS ONLY public.plate_part_templates DROP CONSTRAINT IF EXISTS plate_part_templates_pkey;
ALTER TABLE IF EXISTS ONLY public.plate_part_templates DROP CONSTRAINT IF EXISTS plate_part_templates_name_plate_material_type_id_key;
ALTER TABLE IF EXISTS ONLY public.plate_material_types DROP CONSTRAINT IF EXISTS plate_material_types_pkey;
ALTER TABLE IF EXISTS ONLY public.plate_material_types DROP CONSTRAINT IF EXISTS plate_material_types_name_key;
ALTER TABLE IF EXISTS ONLY public.misc_expenses DROP CONSTRAINT IF EXISTS misc_expenses_pkey;
ALTER TABLE IF EXISTS ONLY public.misc_expense_machine_links DROP CONSTRAINT IF EXISTS misc_expense_machine_links_pkey;
...
ALTER TABLE IF EXISTS ONLY public.material_types DROP CONSTRAINT IF EXISTS material_types_pkey;
ALTER TABLE IF EXISTS ONLY public.material_types DROP CONSTRAINT IF EXISTS material_types_name_key;
ALTER TABLE IF EXISTS ONLY public.material_transactions DROP CONSTRAINT IF EXISTS material_transactions_pkey;
ALTER TABLE IF EXISTS ONLY public.material_inventory DROP CONSTRAINT IF EXISTS material_inventory_pkey;
ALTER TABLE IF EXISTS ONLY public.material_conversions DROP CONSTRAINT IF EXISTS material_conversions_pkey;
ALTER TABLE IF EXISTS ONLY public.machines DROP CONSTRAINT IF EXISTS machines_pkey;
ALTER TABLE IF EXISTS ONLY public.machine_tools DROP CONSTRAINT IF EXISTS machine_tools_pkey;
ALTER TABLE IF EXISTS ONLY public.machine_materials DROP CONSTRAINT IF EXISTS machine_materials_pkey;
ALTER TABLE IF EXISTS ONLY public.machine_labor_costs DROP CONSTRAINT IF EXISTS machine_labor_costs_pkey;
ALTER TABLE IF EXISTS ONLY public.inventory_adjustments DROP CONSTRAINT IF EXISTS inventory_adjustments_pkey;
ALTER TABLE IF EXISTS ONLY public.indirect_expense_categories DROP CONSTRAINT IF EXISTS indirect_expense_categories_pkey;
ALTER TABLE IF EXISTS ONLY public.indirect_cost_allocations DROP CONSTRAINT IF EXISTS indirect_cost_allocations_pkey;
ALTER TABLE IF EXISTS ONLY public.finished_goods DROP CONSTRAINT IF EXISTS finished_goods_pkey;
ALTER TABLE IF EXISTS ONLY public.finished_good_material_reservations DROP CONSTRAINT IF EXISTS finished_good_material_reservations_pkey;
ALTER TABLE IF EXISTS ONLY public.finished_good_material_consumptions DROP CONSTRAINT IF EXISTS finished_good_material_consumptions_pkey;
ALTER TABLE IF EXISTS ONLY public.finished_good_labor DROP CONSTRAINT IF EXISTS finished_good_labor_pkey;
ALTER TABLE IF EXISTS ONLY public.employees DROP CONSTRAINT IF EXISTS employees_pkey;
ALTER TABLE IF EXISTS ONLY public.employee_settlements DROP CONSTRAINT IF EXISTS employee_settlements_pkey;
ALTER TABLE IF EXISTS ONLY public.employee_bonus_payments DROP CONSTRAINT IF EXISTS employee_bonus_payments_pkey;
ALTER TABLE IF EXISTS ONLY public.composite_material_recipes DROP CONSTRAINT IF EXISTS composite_material_recipes_pkey;
ALTER TABLE IF EXISTS ONLY public.composite_material_recipes DROP CONSTRAINT IF EXISTS composite_material_recipes_output_material_id_key;
ALTER TABLE IF EXISTS ONLY public.composite_material_recipe_items DROP CONSTRAINT IF EXISTS composite_material_recipe_items_pkey;
ALTER TABLE IF EXISTS ONLY public.balance DROP CONSTRAINT IF EXISTS balance_pkey;
ALTER TABLE IF EXISTS ONLY public.app_operations_log DROP CONSTRAINT IF EXISTS app_operations_log_pkey;
ALTER TABLE IF EXISTS public.work_types ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.work_logs ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.tools ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.tool_depreciation ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.tax_payments ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.plate_part_templates ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.misc_expenses ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.materials ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.material_types ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.material_transactions ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.material_conversions ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.indirect_expense_categories ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.indirect_cost_allocations ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.finished_goods ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.finished_good_material_reservations ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.finished_good_material_consumptions ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.finished_good_labor ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.employees ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.employee_settlements ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.employee_bonus_payments ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.composite_material_recipes ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.composite_material_recipe_items ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.balance ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.app_operations_log ALTER COLUMN id DROP DEFAULT;
DROP SEQUENCE IF EXISTS public.work_types_id_seq;
...
DROP SEQUENCE IF EXISTS public.tool_depreciation_id_seq;
DROP TABLE IF EXISTS public.tool_depreciation;
DROP SEQUENCE IF EXISTS public.tax_payments_id_seq;
DROP TABLE IF EXISTS public.tax_payments;
...
DROP SEQUENCE IF EXISTS public.plate_part_templates_id_seq;
DROP TABLE IF EXISTS public.plate_part_templates;
DROP TABLE IF EXISTS public.plate_material_types;
DROP SEQUENCE IF EXISTS public.misc_expenses_id_seq;
DROP TABLE IF EXISTS public.misc_expenses;
DROP TABLE IF EXISTS public.misc_expense_machine_links;
DROP SEQUENCE IF EXISTS public.materials_id_seq;
DROP TABLE IF EXISTS public.materials;
DROP SEQUENCE IF EXISTS public.material_types_id_seq;
...
DROP SEQUENCE IF EXISTS public.material_conversions_id_seq;
DROP TABLE IF EXISTS public.material_conversions;
DROP SEQUENCE IF EXISTS public.machines_id_seq;
DROP TABLE IF EXISTS public.machines;
DROP TABLE IF EXISTS public.machine_tools;
DROP TABLE IF EXISTS public.machine_materials;
DROP TABLE IF EXISTS public.machine_labor_costs;
DROP SEQUENCE IF EXISTS public.inventory_adjustments_id_seq;
DROP TABLE IF EXISTS public.inventory_adjustments;
DROP SEQUENCE IF EXISTS public.indirect_expense_categories_id_seq;
DROP TABLE IF EXISTS public.indirect_expense_categories;
DROP SEQUENCE IF EXISTS public.indirect_cost_allocations_id_seq;
DROP TABLE IF EXISTS public.indirect_cost_allocations;
DROP SEQUENCE IF EXISTS public.finished_goods_id_seq;
DROP TABLE IF EXISTS public.finished_goods;
DROP SEQUENCE IF EXISTS public.finished_good_material_reservations_id_seq;
DROP TABLE IF EXISTS public.finished_good_material_reservations;
DROP SEQUENCE IF EXISTS public.finished_good_material_consumptions_id_seq;
DROP TABLE IF EXISTS public.finished_good_material_consumptions;
DROP SEQUENCE IF EXISTS public.finished_good_labor_id_seq;
DROP TABLE IF EXISTS public.finished_good_labor;
DROP SEQUENCE IF EXISTS public.employees_id_seq;
DROP TABLE IF EXISTS public.employees;
DROP SEQUENCE IF EXISTS public.employee_settlements_id_seq;
DROP TABLE IF EXISTS public.employee_settlements;
DROP SEQUENCE IF EXISTS public.employee_bonus_payments_id_seq;
DROP TABLE IF EXISTS public.employee_bonus_payments;
DROP SEQUENCE IF EXISTS public.composite_material_recipes_id_seq;
DROP TABLE IF EXISTS public.composite_material_recipes;
DROP SEQUENCE IF EXISTS public.composite_material_recipe_items_id_seq;
DROP TABLE IF EXISTS public.composite_material_recipe_items;
DROP SEQUENCE IF EXISTS public.balance_id_seq;
DROP TABLE IF EXISTS public.balance;
DROP SEQUENCE IF EXISTS public.app_operations_log_id_seq;
DROP TABLE IF EXISTS public.app_operations_log;
...
SELECT pg_catalog.setval('public.app_operations_log_id_seq', 1, true);
